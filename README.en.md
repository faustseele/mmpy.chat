...
**Demo (with guest mode 👻)**: [Github-Pages](https://faustseele.github.io/mmpy.chat/) & [Netlify](https://mmpy-chat.netlify.app)
...
- **API and deployment** – REST (XHR) + WebSocket; Github-Pages + Netlify
