...
**[Live Demo (with a guest mode! 👻)](https://mmpy-chat.netlify.app/)** &nbsp;·&nbsp; **[Homemade Figma](https://www.figma.com/design/SaTdkvEMsWoRl2dZn7S9Ab/middle.messenger.praktikum.yandex?node-id=0-1&p=f)** &nbsp;·&nbsp; **[API Swagger](https://ya-praktikum.tech/api/v2/swagger)**
